...
import { IHeroSearchProps } from './IHeroSearchProps';
...
export default class HeroSearch extends React.Component<IHeroSearchProps, {}> {
  public render(): React.ReactElement<IHeroSearchProps> {
    return (
      <div>

      <DefaultButton onClick={showModal} text="Open Modal" />
      <Modal
        titleAriaId="ModalDialog1"
        isOpen={true}
        onDismiss={hideModal}
        isBlocking={true}
      ...
      >
        <div className={contentStyles.header}>
          <span id="ModalDialogs1">Lorem Ipsum</span>
          <IconButton
